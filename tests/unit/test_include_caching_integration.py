...
""")
    ...
    def test_caching_in_include_dependency_processing(self):
        ...
        with patch.object(self.parser, '_find_c_files') as mock_find_files, \
             patch.object(self.parser, '_extract_includes_from_file') as mock_extract_includes, \
            ...
            def mock_extract_includes_impl(file_path):
                if "main.c" in str(file_path):
                    return ["header1.h", "header2.h", "missing_header1.h", "missing_header2.h"]
    ...
    def test_cache_cleared_between_projects(self):
        ...
        self.parser._find_included_file("missing_header1.h", self.project_root / "main.c", self.project_root)
        self.parser._find_included_file("missing_header2.h", self.project_root / "main.c", self.project_root)
    ...
    def test_cache_with_real_file_system_operations(self):
        ...
        # First search
        result1 = self.parser._find_included_file(missing_header, self.project_root / "main.c", self.project_root)
        ...
        result2 = self.parser._find_included_file(missing_header, self.project_root / "main.c", self.project_root)
    ...
    def test_cache_with_different_source_files(self):
        ...
        # Search from main.c
        result1 = self.parser._find_included_file("missing_header.h", self.project_root / "main.c", self.project_root)
        self.assertIsNone(result1)
        
        # Search from header1.h (should use cache)
        result2 = self.parser._find_included_file("missing_header.h", self.project_root / "header1.h", self.project_root)
        self.assertIsNone(result2)
    ...
    def test_cache_with_complex_include_chains(self):
        ...
        result1 = self.parser._find_included_file("missing_chain1.h", file_a, self.project_root)
        result2 = self.parser._find_included_file("missing_chain2.h", file_b, self.project_root)
        ...
        result3 = self.parser._find_included_file("missing_chain1.h", file_b, self.project_root)
        result4 = self.parser._find_included_file("missing_chain2.h", file_a, self.project_root)
