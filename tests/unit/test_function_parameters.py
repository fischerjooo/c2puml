...
class TestFunctionParameters(unittest.TestCase):
    ...
    def test_function_parameter_parsing(self):
        ...
        try:
            ...
            process_func = next(f for f in file_model.functions if f.name == 'process_point')
    ...
    def test_function_parameter_display(self):
        ...
        file_model = FileModel(
            ...
            functions=[
                ...
                Function("average", "real_t", [Field("arr", "const int *"), Field("len", "size_t")])
            ]
        )
    ...
    def test_complex_parameter_types(self):
        ...
        file_model = FileModel(
            ...
            encoding_used="utf-8",
            functions=[
                Function("callback", "int", [Field("data", "void *"), Field("user_data", "void *")]),
                Function("array_func", "void", [Field("arr", "int[10]"), Field("size", "size_t")]),
