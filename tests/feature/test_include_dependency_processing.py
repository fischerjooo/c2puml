...
""")
        ...
        self.create_test_file("header1.h", """
#ifndef HEADER1_H
#define HEADER1_H
...
""")
        ...
        self.create_test_file("header2.h", """
#ifndef HEADER2_H
#define HEADER2_H
...
""")
        ...
        self.create_test_file("header3.h", """
#ifndef HEADER3_H
#define HEADER3_H
...
""")
        ...
        self.create_test_file("included.h", """
#ifndef INCLUDED_H
#define INCLUDED_H
...
""")
        ...
        self.create_test_file("excluded.h", """
#ifndef EXCLUDED_H
#define EXCLUDED_H
...
""")
        ...
        self.create_test_file("include/header1.h", """
#ifndef HEADER1_H
#define HEADER1_H
...
""")
        ...
        subsubdir.mkdir()
        self.create_test_file("include/subdir/header2.h", """
#ifndef HEADER2_H
#define HEADER2_H
...
""")
    ...
    def test_include_extraction_from_file(self):
        ...
        test_file = self.create_test_file("test.c", """
#include <stdio.h>
#include <stdlib.h>
#include "local1.h"
#include "local2.h"
...
""")
        ...
        expected_includes = ["stdio.h", "stdlib.h", "local1.h", "local2.h", "subdir/header.h"]
