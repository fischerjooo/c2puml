...
'''
        ...
        self.assertTrue(model_exists, f"Model file not found at {model_file} or {workspace_model_file}")
...
''')
        ...
        self.create_test_file("level1.h", '''
#ifndef LEVEL1_H
#define LEVEL1_H
#include "level2.h"
...
''')
        ...
        self.create_test_file("level2.h", '''
#ifndef LEVEL2_H
#define LEVEL2_H
#include "level3.h"
...
''')
        ...
        self.create_test_file("level3.h", '''
#ifndef LEVEL3_H
#define LEVEL3_H
...
''')
        ...
        self.create_test_file("existing.h", '''
#ifndef EXISTING_H
#define EXISTING_H
