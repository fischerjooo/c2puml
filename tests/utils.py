...
from c_to_plantuml.models import FileModel, ProjectModel, Struct, Function, Enum
...
class ProjectBuilder:
    ...
    def add_c_file(self, filename: str, content: str, subdir: str = "") -> 'TestProjectBuilder':
        """Add a C source file to the test project."""
        return self._add_file(filename, content, subdir, ".c")
    
    def add_h_file(self, filename: str, content: str, subdir: str = "") -> 'TestProjectBuilder':
        """Add a C header file to the test project."""
        return self._add_file(filename, content, subdir, ".h")
    
    def add_config(self, config_data: Dict[str, Any], filename: str = "config.json") -> 'TestProjectBuilder':
    ...
    def _add_file(self, filename: str, content: str, subdir: str = "", extension: str = "") -> 'TestProjectBuilder':
...
class AssertionHelpers:
    ...
    @staticmethod
    def assert_file_contains_includes(file_model: FileModel, expected_includes: List[str]) -> None:
    ...
    def assert_struct_exists(file_model: FileModel, struct_name: str) -> Struct:
        ...
        raise AssertionError(f"Struct '{struct_name}' not found. Available: {available_structs}")
    ...
    def assert_function_exists(file_model: FileModel, function_name: str) -> Function:
        ...
        raise AssertionError(f"Function '{function_name}' not found. Available: {available_functions}")
