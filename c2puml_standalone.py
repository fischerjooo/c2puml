#!/usr/bin/env python3
"""
Standalone C to PlantUML converter

This script allows running c2puml without installation by adding the src directory
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="C to PlantUML Converter (Standalone Version)",
