#!/usr/bin/env python3
"""
Optimized main entry point for C to PlantUML converter with JSON model approach
"""
...
from .generators.model_plantuml_generator import generate_plantuml_from_json

def main():
    """Main entry point for the optimized C to PlantUML converter"""
    parser = argparse.ArgumentParser(
        description="Convert C/C++ projects to PlantUML diagrams using optimized parsing and JSON models"
    )
    ...
    if args.verbose:
        print(f"C to PlantUML Converter (Optimized)")
