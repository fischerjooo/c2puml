...
class Transformer:
    ...
    def transform(self, model_file: str, config_file: str, output_file: str = None) -> str:
        """
    ...
    def _apply_transformations(self, model: ProjectModel, config: Dict[str, Any]) -> ProjectModel:
        ...
        self.logger.info(f"Transformations complete. Model now has {len(model.files)} files")
        return model
    
    def _apply_file_filters(self, model: ProjectModel, filters: Dict[str, Any]) -> ProjectModel:
    ...
    def _apply_element_filters(self, model: ProjectModel, filters: Dict[str, Any]) -> ProjectModel:
    ...
    def _filter_file_elements(self, file_model: FileModel, filters: Dict[str, Any]) -> FileModel:
        ...
        if 'unions' in filters:
            file_model.unions = self._filter_dict(
                file_model.unions, 
                filters['unions']
            )
        ...
        if 'macros' in filters:
            file_model.macros = self._filter_list(
                file_model.macros, 
                filters['macros']
            )
    ...
    def _apply_model_transformations(self, model: ProjectModel, transformations: Dict[str, Any]) -> ProjectModel:
    ...
    def _apply_renaming(self, model: ProjectModel, rename_config: Dict[str, Any]) -> ProjectModel:
    ...
    def _apply_additions(self, model: ProjectModel, add_config: Dict[str, Any]) -> ProjectModel:
    ...
    def _apply_removals(self, model: ProjectModel, remove_config: Dict[str, Any]) -> ProjectModel:
    ...
    def _should_include_file(self, file_path: str, include_patterns: List[re.Pattern], 
